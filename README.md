...
A lot of macros for add-ons are heavliy intigrated making this quite a mess for mass use. If certain add ons like led-effect aren't installed you will get a lot of command not found errors. 
I use an ERCF so Happy Hare is also pretty well intigrated into these macros. There are also a few changes to macros included with happy hare, lots of changes to blobifier and a set of maco helper for tuning.
...
Jualianschill: <https://github.com/julianschill/klipper-led_effect/tree/master>
